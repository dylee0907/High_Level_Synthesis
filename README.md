...
1. HLL 코드를 이해하고 HDL 코드로 바꾸러면 시간과 돈이 많이 든다. (삼성은 돈이 많아서 그냥 하는듯 하다. 참고로 걔네는 python으로 하기 때문에 여러분의 S22 발열이 미쳤던 이유가 사실 여기 있다.)
...
여기까지 벌써 논문의 1/3은 끝났다. 졸린 관계로 차후 이어서 작성하겠다....
